...
public class ReturnChainTest {
	...
	public void composite() {
		CompositeToResult<String, String> composite = new CompositeToResult<String, String>()
				.add(new MatcherToResult<>(functional(string -> string.equals("hello"), string -> "world")))
				.add(new MatcherToResult<>(functional(string -> string.equals("helloWorld"), string -> "worldHello")));
	...
	public void matchedToResult() {
		MatcherToResult<String, String> matched =
				new MatcherToResult<>(functional(string -> string.equals("hello"), string -> "world"));
